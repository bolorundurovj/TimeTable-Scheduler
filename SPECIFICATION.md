...
- **Documentation repositories**: Repositories without any functional code. For instance, [TimeTable/wiki](https://github.com/bolorundurovj/TimeTable-Scheduler/wiki).
