...
public class ResultSetTableModel extends AbstractTableModel {
    ...
    /**
     * Initialize resultSet and obtain its meta data object. <br>
    ...
    public ResultSetTableModel(String query, String[] colName) throws SQLException, ClassNotFoundException {
        ...
        connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/time_table_scheduling?serverTimezone=UTC", "root", "rootroot");
