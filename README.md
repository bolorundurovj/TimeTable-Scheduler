...
This repo contaiins the source code for a time table scheduler. The time table is generated based on a genetic algorithm with seeded data of the levels and time slots, courses, lecturers, availbale lecture halls and their capacities will be inputed bt the admisntrator. This algorithm then generates possible outcomes known as chromosones.
The database was designed using the class diagram displayed in the image below which display the available datasets used in the genetic algorithm.
![f91d068a-8bcc-417e-bbdb-39cf8bd26519](https://user-images.githubusercontent.com/45286636/154258582-6e1f295f-fc77-4d9c-9c9a-87f053aea76e.jpg)

The genetic algorithm makes use of the equation  
